...
Right now, I’m building **ScrapeSmith**, a cloud-based SaaS platform for automated web scraping, data cleaning, and AI-powered analysis using an API-gateway microservices architecture.
